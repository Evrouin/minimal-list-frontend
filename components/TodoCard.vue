...
<template>
  ...
  >
    ...
    <img v-if="todo.editing && (todo.thumbnail || todo.image)" :src="todo.thumbnail || todo.image" class="-mx-5 -mt-5 mb-1 block h-32 rounded-t object-cover" style="width: calc(100% + 2.5rem); min-width: calc(100% + 2.5rem); max-width: none" />
